<template>
    <div>
            ...
            <transition enter-active-class="animated zoomIn" leave-active-class="animated fadeOut zoomOut">
                <b-row v-if="form.typesiteoper=='PFC'||form.typesiteoper=='PF' ">
                    <b-col cols="8">
                            <b-form-group>
                                <div>
                    ...
                    <b-col cols="4">
                            <b-form-group>
                                <div>
                                    ...
                                    <select v-model="form.exercicefiscal" class="m-0 p-0"  style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 2px) !important;">
                                    <option selected> {{ form.exercicefiscal }}</option>
                    ...
                    <b-col cols="8">
                            ...
                            <div>
                                <label for="" class="m-0 p-0" style="font-weight:300"><span style="color: red;font-size: .9rem">*</span> Localité</label>
                                 <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.localite" />
            ...
            <b-row>
              <b-col>
                    <b-form-group>
                      <div>
                        <label for="" class="m-0 p-0" style="font-weight:300">Région</label>
              ...
              <b-col>
                    <b-form-group>
                      <div>
                        <label for="" class="m-0 p-0" style="font-weight:300">Departement</label>
                        <select :disabled="disableDep" v-model="form.iddepartement" class="m-0 p-0"  style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 2px) !important;">
                            <option v-for="departement in _departements" :key="departement.iddepartement" :value="departement.iddepartement"> {{ departement.intitule }}</option>
                        </select>
             ...
             <b-row>
              <b-col>
                    <b-form-group>
                      <div>
                        <label for="" class="m-0 p-0" style="font-weight:300">Arrondissement</label>
            ...
            <b-card >
                ...
                <b-row>
                    ...
                    <b-col>
                        ...
                        <b-form-input name="x" size="sm" class="p-0 m-0" placeholder="" v-model="form.utmx" v-validate="{ required: true}" :state="validateState('x')" aria-describedby="x" data-vv-as="x"/>
                    ...
                    <b-col>
                        ...
                        <b-form-input name="y" size="sm" class="p-0 m-0" placeholder="" v-model="form.utmy" v-validate="{ required: true}" :state="validateState('y')" aria-describedby="y" data-vv-as="y"/>
             ...
             <transition enter-active-class="animated zoomIn" leave-active-class="animated fadeOut zoomOut">
                <b-row v-if="form.typesiteoper=='PU'">
                    <h6 class="mb-0 font-weight-bold text-center">Autorisation d'enregistrement du site</h6>
                    <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300">Attacher du certificat</label>
                        <input type="file" size="sm" class="w-100 p-0 m-0" placeholder=""/>
                    </b-form-group>
                </b-row>
            </transition>

            <transition enter-active-class="animated zoomIn" leave-active-class="animated fadeOut zoomOut">
                <b-row v-if="form.typesiteoper=='PP'">
                    <b-form-group>
