<template>
    <div>
            <b-row>
              <b-col>
                     <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300"><span style="color: red">*</span>Code de l'enregistrement</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.intitule" />
                    </b-form-group>
                    <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300"><span style="color: red">*</span>Nom de l'entité</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.intitule" />
                    </b-form-group>
                      ...
                      <b-form-group  class="m-0 p-0">
                        <label for="" class="font-weight: bold m-0 p-0"><strong>Pays</strong></label><br>
                         <select v-model="search.status" class="m-0 p-0" style="width: 70%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 2px) !important;">
                      ...
                      <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300">Nom du responsable</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 mt-2" placeholder="" v-model="form.intitule" />
                    </b-form-group>

                </b-col>
                <b-col>
                    <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300"><span style="color: red">*</span>Adresse</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.intitule" />
                    </b-form-group>

                     <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300"><span style="color: red">*</span>Email</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.intitule" />
                    </b-form-group>

                     <b-form-group>
                        <label class="p-0 m-0" style="font-weight:300"><span style="color: red">*</span>Téléphone</label>
                        <b-form-input size="sm" name="nomSite" class="w-100 p-0 m-0" placeholder="" v-model="form.intitule" />
                    </b-form-group>

                       <b-form-group>
                    <label><span style="color: red">*</span>Attacher recommandation</label>
                  
                     <b-form-file id="file-small" size="sm" placeholder="aucun fichier choisi"></b-form-file>
                </b-form-group>
    ...
    methods: {
        getLocalites() {
          ...
          if(!this.$store.state.pays){
            ...
            try {
                this.pays =  await this.$boisCemac.get("pays").then(response => response.data.result.items);
