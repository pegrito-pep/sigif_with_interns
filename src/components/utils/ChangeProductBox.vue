<template>
    <popup-modal size="sm" ref="popup">
        ...
        <p class="text-center mt-4"  show>
                        <i class="fa fa-ban fa-3x" style="color: red" ></i> <br>
                        <span class="h6 d-inline-flex ml-2">Voulez-vous vraiment changer de type de produit ? {{ message }}</span>
                    </p> 
