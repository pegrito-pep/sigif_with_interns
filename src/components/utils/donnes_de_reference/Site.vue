    ...
    <data-modal size="sm" ref="popup">
        ...
        <div class="px-2 pt-2 pb-1">
            ...
            <b-row v-if="intitule!=undefined||numfacture!=undefined">
                <b-col cols="6"><p><span class="text-uppercase">Intitulé: <b>{{ intitule }}</b></span></p> </b-col>
                <b-col cols="6"><p><span class="text-uppercase">N° de bordereau: <b>{{ numfacture }}</b></span></p> </b-col>
            </b-row>
