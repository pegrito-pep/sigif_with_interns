<template>
    <data-modal ref="popup">
        ...
        <div v-if="errorSet==true" class="px-4 pt-2 pb-4">
        ...
        <div><p class="text-center mt-2" :class="classSet" style="font-size: 16px">{{ message }}</p></div>
    </data-modal>
</template>
...
export default {
    ...
    methods: {
        show(opts = {}) {
            ...
            this.classSet= opts.classSet
            this.errorSet= opts.errorSet
