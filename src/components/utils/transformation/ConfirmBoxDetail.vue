<template>
    <data-modal size="sm" ref="popup">
        ...
        <div class="px-2 pt-2 pb-1">
            ...
            <b-row v-if="entite!=undefined&&site!=undefined&&ligne!=undefined">
                <b-col><p><span class="text-uppercase">organisation: <b>{{ entite }}</b></span></p> </b-col>
                <b-col><p><span class="text-uppercase">utb: <b>{{ site }}</b></span></p> </b-col>
                <b-col><p><span class="text-uppercase">ligne: <b>{{ ligne }}</b></span></p> </b-col>
            </b-row>
