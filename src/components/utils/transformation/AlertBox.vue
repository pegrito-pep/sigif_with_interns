<template>
    <data-modal size="lg" ref="popup">
        ...
        <div class="px-4 pt-2 pb-4">
            ...
            <b-row class="mb-0" v-if="entite!=''">
                <b-col>
                    <h5 class="text-muted text-center"> entité : <span class="font-weight-bold mr-1">{{ entite }}</span></h5>
                </b-col>
            </b-row>
            <b-row class="mb-0" v-if="site!=''&&ligne!=''">
                <b-col cols="7"><h5 class="text-muted text-center"> site :<span class="font-weight-bold mr-1">{{ site }}</span></h5></b-col>
                <b-col v-if="commande=='entreeUsinage'"><h5 class="text-muted"> ligne : <span class="font-weight-bold">{{ ligne }}</span></h5></b-col>
            </b-row>
            <hr>
...
export default {
    ...
    data: () => ({
        ...
        entite: undefined, // login
        site: undefined, // nom
        ligne: undefined, // prenom
    ...
    methods: {
        show(opts = {}) {
            ...
            this.entite = opts.entite
            this.site = opts.site
            this.ligne = opts.ligne
