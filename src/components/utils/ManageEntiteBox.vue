<template>
    <data-modal size="lg" ref="popup">
        ...
        <div class="px-4 pt-2 pb-4">
            ...
            <b-row class="mb-0 text-center">
                <b-col>
                    <span class="text-muted"> Raison sociale : </span><span class="font-weight-bold mr-1" style="font-size:1em">{{ raisonsociale }}</span>
                </b-col>
            </b-row>
            <b-row class="mb-0 text-center">
                <b-col>
                    <span class="text-muted"> Type d'organisation : </span><span class="font-weight-bold mr-1" style="font-size:1em">{{ typeorganisation }}</span>
                </b-col>
            </b-row>
            <b-row class="mb-0 text-center">
                <b-col><span class="text-muted"> E-Mail : </span> <span class="font-weight-bold" style="font-size:1em">{{ email }}</span></b-col>
            </b-row>
            <hr>
...
export default {
    ...
    data: () => ({
        ...
        raisonsociale: undefined, // login
        typeorganisation: undefined, // nom
        email: undefined, // prenom
    ...
    methods: {
        show(opts = {}) {
            ...
            this.raisonsociale = opts.raisonsociale
            this.typeorganisation = opts.typeorganisation
