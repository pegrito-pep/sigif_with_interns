<template>
    <data-modal size="lg" ref="popup">
        <div style="background: rgb(0, 82, 44) !important; height:35px;" class="header d-flex justify-content-between pb-3">
        ...
        <div class="px-4 pt-2 pb-4">
            <div class="d-flex align-center justify-content-center">
                  ...
                  <b-alert variant="light" class="text-center" show>
                        <i class="fa fa-ban fa-3x text-danger"></i> <br>
                        <span class="h4 d-inline-flex ml-2 text-danger">Attention, ce code barre n'est pas valide !!!</span>
                    </b-alert> 
