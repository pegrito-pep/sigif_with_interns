                  ...
                  <b-col cols="3">
                    ...
                    <template #label>
                      <div class="label-form">
                        <span class="label-form">Organisation</span>
                      </div>
                    </template>
                      <select style="height: calc(1em + .300rem + 1px) !important;width:50%" class="form-control p-1" size="sm">
                        <option value=""></option>
                      </select>
                    </b-form-group>
                    <b-form-group class="p-0 m-0"
                    ...
                    <template #label>
                      <div class="label-form">
                        <span class="label-form">Du</span>
                      </div>
                    </template>
                    <input type="date" v-model="datedeb"/>
                    <!-- <b-form-datepicker style="height: calc(1em + .600rem + 1px) !important;width:70%;" id="datepicker" size="sm" placeholder="dd/mm/yyyy"></b-form-datepicker> -->
                    </b-form-group>
                  </b-col>
                  <b-col cols="3">
                    <b-form-group class="p-0 m-0"
                    ...
                    <template #label>
                      <div class="label-form">
                        <span class="label-form">Statut</span>
                      </div>
                    </template>
                      <select style="height: calc(1em + .600rem + 1px) !important;font-size:0.8rem;width:70%" class="form-control p-1" size="sm">
                        <option value=""></option>
                        <option value="brouillon">Brouillon</option>
                        <option value="s">Soumis</option>
                    ...
                    <template #label>
                      <div class="label-form">
                        <span class="label-form">Au</span>
                      </div>
                    </template>
                    <input type="date" v-model="datefin"/>
                    <!-- <b-form-datepicker style="height: calc(1em + .500rem + 1px) !important;width:70%" id="datepicker" size="sm" placeholder="dd/mm/yyyy"></b-form-datepicker> -->
                    </b-form-group>
                  </b-col>
                </b-row>
              <b-row class="mt-15 position_absolute">
        ...
        <div class="m-0 px-2 table-header-border">
          <b-row>
            <b-col><h4 class="tab-header-left-text">
              ...
              Certificats d'exportateur</h4></b-col>
...
data: () => ({
  ...
  fields: [
      ...
      { key: 'organisation', label: 'Organisation',thStyle:{color:'green'} },
      { key: 'nro_enregistrement', label: 'Numéro d\'enregistrement',thStyle:{color:'green'} },
      { key: 'typeproduit', label: 'Type de produit',thStyle:{color:'green'} },
      { key: 'validite', label: 'Validité',thStyle:{color:'green'} },
...
showDetailsCertificat(){
  this.$router.push({name: 'demande_certificat_exportateur-detail'})
}
