<template>
  <div id="cover" class="min-vh-100">
            ...
            <b-card class="b-card">
                ...
                <b-row class="mt-0">
                  <b-col cols="3">
                    ...
                    <input type="date" v-model="datedemande" class="default-old-system-select-properties"/>
                  </b-form-group>
                    <b-form-group class="p-0 m-0"
                      label-align="right"
                      label-cols="6"
                  ...
                  <b-col cols="3" class="mt-1">
                    ...
                    <template #label>
                      ...
                      <input type="date" v-model="datedeb" class="default-old-system-select-properties"/>
                    </b-form-group>
                    <b-form-group class="p-0 m-0"
                      label-align="right"
                      label-cols="6"
                  ...
                  <b-col cols="3" class="mt-1">
                    ...
                    <template #label>
                      ...
                      <input type="date" v-model="datefin" class="default-old-system-select-properties"/>
                    </b-form-group>
                  </b-col>
        ...
        <div class="m-0 px-2 table-header-border">
          <b-row>
            <b-col><h4 class="tab-header-left-text">Attestations de conformité de produits</h4></b-col>
            <b-col class="col-md-auto">
              <a :disabled="canCreateUtilisateur" @click.prevent="createAcp" size="sm" :class="{'change-image-opacity': !canCreateUtilisateur,  'not-change-image-opacity': canCreateUtilisateur}" class="mx-1 simple-btn"><b-img  src="@/assets/images/iconPLUS_16x16.png"></b-img> Créer</a>
              <span >
        ...
        <div class="ml-1">
            <b-table  :busy="isBusy" hover  select-mode="single" responsive="sm" ref="selectableTable"
              ...
              <template #cell(numDemandeAcp)="data">
                <span class="d-flex justify-content-center align-items-center">{{ data.item.numDemandeAcp }}</span>
              </template>
              <template #cell(statut)="data">
                <span>{{ data.item.statut }}</span>
              </template>
...
methods: {
  createAcp(){
    this.$router.push({name: 'acp-create'})
  },
  rowClass(item, type) {
    if(item !=''&&item!=null){
  ...
  getAcp(){
    this.isBusy=true
      ...
      this.$exportations.get("Acp", {params}).then(response => {
...
if (sidebar.style.width !== '0px'){
  ...
  showDetailsACP(){
    this.$router.push({
      ...
      params: { id: this.selected[0].numDemandeAcp },
    });
  },
},
