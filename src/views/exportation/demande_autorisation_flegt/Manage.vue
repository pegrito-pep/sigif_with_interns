<template>
  <div id="cover" class="min-vh-100">
            ...
            <b-card class="b-card">
                ...
                <b-row class="mt-0">
                  <b-col cols="3">
                    ...
                    <input type="date" v-model="datedemande"/>
                    <!-- <date-picker v-model="datedemande" placeholder="dd/mm/yyyy" style="height: calc(1em + .200rem + 1px) !important;width:100%" class="p-0" size="sm"></date-picker> -->
                  ...
                  <b-input  style="height: calc(1em + .600rem + 1px) !important;width:125%" class="" size="sm"></b-input>
                  </b-form-group>
                  </div>
                  ...
                  <b-col cols="3">
                    ...
                    <input type="date" v-model="datedeb"/>
                    <!-- <date-picker v-model="datedeb" placeholder="dd/mm/yyyy" style="height: calc(1em + .600rem + 1px) !important;width:100%" size="sm"></date-picker> -->
                    </b-form-group>
                    <b-form-group class="p-0 m-0"
                      label-align="right"
                      label-cols="6"
                  ...
                  <b-col cols="3">
                    ...
                    <!-- <date-picker v-model="datefin" placeholder="dd/mm/yyyy" style="height: calc(1em + .600rem + 1px) !important;width:100%" size="sm"></date-picker> -->
                    </b-form-group>
                  </b-col>
        ...
        <div class="m-0 px-2 table-header-border">
          <b-row>
            <b-col><h4 class="tab-header-left-text"> Demandes d'autorisation FLEGT</h4></b-col>
            <b-col class="col-md-auto">
              <a :disabled="canCreateUtilisateur" @click.prevent="createDemandeAuthFLEGT" size="sm" :class="{'change-image-opacity': !canCreateUtilisateur,  'not-change-image-opacity': canCreateUtilisateur}" class="mx-1 simple-btn"><b-img  src="@/assets/images/iconPLUS_16x16.png"></b-img> Créer</a>
              <span >
...
data: () => ({
  ...
  fields: [
      ...
      { key: 'codebarre', label: 'Code barre FLEGT' ,thStyle:{color:'green',width:'10%'}},
      { key: 'dateactivation', label: 'Date d\'activation' ,thStyle:{color:'green',width:'8%'}},
      { key: 'expediteur', label: 'Expéditeur',thStyle:{color:'green',width:'7%'} },
      { key: 'destinataire', label: 'Destinataire',thStyle:{color:'green'} }, 
      { key: 'numconnaissement', label: 'N° connaissement',thStyle:{color:'green',width:'10%'} }, 
      { key: 'numdeclarationex1', label: 'N° déclaration EX1',thStyle:{color:'green',width:'9%'} }, 
      { key: 'portembarquement', label: 'Port embarquement',thStyle:{color:'green',width:'9%'} },
      { key: 'portdebarquement', label: 'Port débarquement',thStyle:{color:'green',width:'9%'} },
      ...
      { key: 'nmbunite', label: 'Nombre d\'unités',thStyle:{color:'green',width:'10%'} },
  ],
  elements: [
  ],
    json:{
...
getDemandesAutFLEGT(){
  this.isBusy=true;
  this.$exportations.get('authorisationflegt')
    .then(response=>{
      this.elements=response.data.result.Items
      this.elements.map(elt=>{
          elt.datedemande = elt.datedemande !==null ? this.$dayjs(elt.datedemande).format('DD/MM/YYYY') :""
          elt.dateactivation = elt.dateactivation !==null ? this.$dayjs(elt.dateactivation).format('DD/MM/YYYY') :""
...
createDemandeAuthFLEGT(){
  this.$router.push({name: 'create-demande_autorisation_flegt'})
}
},
