<template>
    <div id="cover" class="min-vh-100">
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"> Liste des BSE</h4></b-col>
              <b-col class="col-md-auto">
                ...
                <a @click="showDetailsBSE" :disabled="canViewDetailsBSE" size="sm" :class="{'change-image-opacity': !canViewDetailsBSE,  'not-change-image-opacity': canViewDetailsBSE}" class="mx-1 simple-btn"><b-img :class="{'change-image-opacity': !canViewDetailsBSE}" src="@/assets/images/iconVISUALISER_16x16.png"></b-img>consulter</a>
...
export default {
  ...
  data: () => ({
    ...
    //données du tableaux
    fields: [
        { key: 'codebarre', label: 'Code barre',thStyle:{color:'green',width:'7%',fontSize:'.7rem'} },
 ...
 methods: {
  filterTable(){
    ...
    this.isBusy=true
    this.$exportations.post("bulletinExport/search", data).then((response) => {
  ...
  getBses(){
    ...
    this.$exportations.get("bulletinExport", {params}).then(response => {
