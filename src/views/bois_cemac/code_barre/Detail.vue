          ...
          <div>
              ...
              <b-col>
                <h4 class="tab-header-left-text">
                  ...
                  >Consultation du lot a code à barre  n°  {{ lotCodes.numlot }}</span>
                </h4>
              </b-col>
              ...
              <b-row class="align-item-center d-flex justify-content-center ">
                  ...
                  <b-col class="b-col" cols="7">
                     <h6><strong v-if="lotCodes.datedemande !==null">{{ this.$dayjs(lotCodes.datedemande) }}</strong> <i class="fa fa-calendar mt-1" aria-hidden="true"></i></h6><br>
                         <h6><strong>{{ lotCodes.nombre }}</strong></h6><br>
                          <h6 ><strong>{{ lotCodes.usage }}</strong></h6><br>
                           <h6 ><strong v-if="lotCodes.typetitre !==null">{{ lotCodes.typetitre }} </strong><strong v-else>non défini </strong></h6><br>
                  </b-col>
...
fields: [ 
  ...
  computed:{
    ...
    items() { 
      ...
      return this.lotCodes.codes.map((a, index) => {  
        a.isFirst = index == 0        
        a.isEven = index %2 == 0        
        return a
      })
 ...
 methods: {
  fermer() {
      this.$router.push({ name: "code_barres" });
  },
  async getDetailsCodeBarres() {
    ...
    console.log('lot code',this.lotsCodes );
      ...
      <b-row class="d-flex justify-content-center">
        <b-col class="mt-4" cols="6">
          ...
          <p class="mt-0">
            ...
            ><strong style="font-size: 20px"
              >{{ detailSite.entite }}Assistant</strong
            >
          </p>
          ...
          <p class="mt-0">
            ...
            ><strong style="font-size: 20px"
              >{{ detailSite.entite }}Pedro@gmail.com</strong
            >
          </p>
          ...
          ><strong style="font-size: 20px"
            >{{ detailSite.departement }}
            <b-badge v-if="userdetail.active" variant="success">oui</b-badge>
        ...
        <b-col class="mt-4" cols="6">
          ...
          ><strong style="font-size: 20px">{{ detailSite.region }}BLCAM</strong
          ><br />
          <br />

          <span class="text-muted"><strong>Types utilisateur: </strong></span
          ><strong style="font-size: 20px"
            >{{ detailSite.arrondissement }}Opérateur</strong
          ><br />
          <br />
          ...
          <p>
            ...
            ><strong style="font-size: 20px"
              >{{ detailSite.departement }}BOIS LEGALE CAMEROUN</strong
            >
          </p>
          ...
          ><strong style="font-size: 20px"
            >{{ detailSite.departement }}Francais</strong
          >
          <br />
          <br />
        </b-col>
