<template>
    <div class="for_commun_cp">
        <tab-head :fermer="fermer" title="Vente de coupe n°"></tab-head>
                ...
                <b-col cols="6">
                    ...
                    >
                        <select disabled style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 1px) !important;">
                            <option value="ccp">Forêt communautaire en convention provisoire</option>
                        </select>
                    </b-form-group>
                    <b-form-group class="p-0 m-0"
        ...
        <div>
            <b-row>
                <b-col>
                    <b-tabs>
                        <b-tab title="Vente de coupe n° 0904720">
                            <div class="ml-1 pl-3" style="border:1px solid grey">
                                <b-row>
                                    <b-col cols="5">
                                        ...
                                        <b-form-group class="p-0 m-0"
                                            label="Convention provisoire d'exploitation"
                                            label-cols="7"
                                        >
                        ...
                        <b-tab title="Localisation vente de coupe n° 0904720">
...
<script>
    ...
    export default{
        ...
        methods:{
            fermer(){
                this.$router.push({name: 'foret_communautaire_en_cp' })
            },
            rowClass(item, type) {
                if(item !=''&&item!=null){
