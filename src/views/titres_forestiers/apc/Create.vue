        ...
        <div>
          ...
          <div>
              <b-row class="m-4">
                  ...
                  <b-row class="m-2">
                    ...
                    <b-col cols="8">
                      <select disabled v-model="form.typetitre" class="m-0 p-0"  style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 2px) !important;">
                        <option value="APC" selected disabled> Autorisation personnelle de coupe</option>
                      </select>
                    </b-col>
                  </b-row>
                ...
                <b-col cols="4">
                  <b-row class="m-2">
                    <b-col cols="6">  Catalogue APC N°</b-col>
                    <b-col cols="4">
                  ...
                  <b-row class="m-2">
                    <b-col cols="6">Volume</b-col>
                    <b-col cols="4">
                      <b-form-input v-model="form.volume" name="volume" size="sm" class="p-0 m-0 font-weight-300 form-control-xs" placeholder=""  v-validate="{ required: true, min: 4 }" :state="validateState('volume')"/>
                      <b-form-invalid-feedback id="volume">{{ veeErrors.first('volume') }}</b-form-invalid-feedback>
                    </b-col>
                  </b-row>
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item" :class="{ custumSigifTab: section === 'apc' }">
                    ...
                    class="nav-link"
                    style="color: inherit"
                    @click.prevent="section = 'apc'"
                    >Autorisation personnelle de coupe n° </a>
                </li>
              </ul>

              <b-container class="contents" fluid v-if="section == 'apc'">
                <b-row class="w-100 mx-3 d-flex justify-content-between">
                  ...
                  <b-col cols="4">
                    <b-form-group label-cols="5" label-class="font-weight-normal" label-cols-lg="5" label-size="sm" label="N° acte attribution" label-for="input-sm">
                      <b-form-input v-model="form.arreteattribution" name="arreteattribution" size="sm" class="w-50 p-0 m-0 font-weight-300 form-control-xs" placeholder=""  v-validate="{ required: true, min: 4 }" :state="validateState('arreteattribution')"/>
                      <b-form-invalid-feedback id="arreteattribution">{{ veeErrors.first('arreteattribution') }}</b-form-invalid-feedback>
                    </b-form-group>
                  
                    <b-form-group label-cols="5" label-class="font-weight-normal" label-cols-lg="5" label-size="sm" label="Montant Total de la vente" label-for="input-sm">
                      <b-form-input v-model="form.montantoffre" name="montantoffre" size="sm" class="w-50 p-0 m-0 font-weight-300 form-control-xs" placeholder=""  v-validate="{ required: true, min: 4 }" :state="validateState('montantoffre')"/>
                    ...
                    <b-form-group label-cols="5" label-class="font-weight-normal" label-cols-lg="5" label-size="sm" label="N° notification" label-for="input-sm">
                      <b-form-input v-model="form.numnotificationapprobation" name="numnotificationapprobation" size="sm" class="w-50 p-0 m-0 font-weight-300 form-control-xs" placeholder=""  v-validate="{ required: true, min: 2 }" :state="validateState('numnotificationapprobation')"/>
...
export default {
  ...
  methods: {
    ...
    getTitres(){
      ...
      this.$titres.get("titres/ap?size=400", {params}).then(response => {
