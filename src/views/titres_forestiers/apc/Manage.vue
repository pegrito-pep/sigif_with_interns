          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col>
                ...
                <!-- <a :disabled="canCreateUtilisateur" @click.prevent="addUser" size="sm" :class="{'change-image-opacity': !canCreateUtilisateur,  'not-change-image-opacity': canCreateUtilisateur}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/Parcs_Rupture_16x16.png"></b-img> UFA</a>
                ...
                <a :disabled="canCreateUtilisateur" @click.prevent="addUser" size="sm" :class="{'change-image-opacity': !canCreateUtilisateur,  'not-change-image-opacity': canCreateUtilisateur}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/iconINVENTAIRE_16x16.png"></b-img> Contrat de partenariat</a> -->
              </b-col>
              <b-col class="col-md-auto">
                <span class="d-flex">
                  <a :disabled="!canCreateTitreApc" @click.prevent="goToCreateTitreAPC" size="sm" :class="{'change-image-opacity': !canCreateTitreApc,  'not-change-image-opacity': canCreateTitreApc}" class="mx-1 simple-btn"><b-img src="@/assets/images/iconPLUS_16x16.png"></b-img>Creer</a>
                  ...
                  <a :disabled="canViewDetailsAPC" @click.prevent="showDetails" size="sm" :class="{'change-image-opacity': !canViewDetailsAPC,  'not-change-image-opacity': canViewDetailsAPC}" class="mx-1 simple-btn"><b-img :class="{'change-image-opacity': !canViewDetailsAPC}" src="@/assets/images/iconVISUALISER_16x16.png"></b-img>consulter</a>
...
export default {
  ...
  computed:{
    ...
    canCreateTitreApc(){return true; return this.hasAccess('CREER_CONCESSION_DEFINITIVE')},
 ...
 methods: {
  goToCreateTitreAPC(){this.$router.push({ name: "create-titre-apc" });},
  showDetails(){
    this.$router.push({name: 'apc-details' }); 
  },
  rowClass(item, type) {
    if(item !=''&&item!=null){
  ...
  getTitres(){
     this.isBusy=true
      ...
      this.$titres.get("titres/ap", {params}).then(response => {
    ...
    filterTable() {
      ...
      this.isBusy=true
      this.$titres.post("titres/ap/search", this.search).then((response) => {
          this.total = response.data.result.totalItems
          this.currentPage = response.data.result.currentPage + 1
          this.elements=response.data.result.items
