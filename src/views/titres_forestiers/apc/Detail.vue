<template>
    <div class="for_commun_cp">
        <tab-head :fermer="fermer" title="APC"></tab-head>
        ...
        <div>
            <b-row>
                <b-col>
                    <b-tabs>
                        <b-tab title="Autorisation personnelle de coupe n° 0904720">
