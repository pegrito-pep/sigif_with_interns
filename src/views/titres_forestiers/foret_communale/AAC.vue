        ...
        <b-overlay :show="showOverlay" rounded="sm">
            <div class="m-0">
                <tab-head
                    ...
                    :nouveau="nouveau"
                    :canAddNew="canAddNew"
                    title="Assiette de la forêt communale n°"
                    :idElement="idElement"
                >
                </tab-head> 
                    ...
                    <b-row>
                        <b-col cols="7">
                            ...
                            <div>
                                ...
                                >
                                    <template #label>
                                        <span v-if="showNewForm" style="color:red;font-weight: bold;">*</span>UFE
                                    </template>
                                ...
                                >
                                    ...
                                    <input v-else  type="text" disabled :value="selected.superficieAac" class="w-15 mt-2  default-old-system-input-properties" style="background-color:#eee;"/>
                                    <!-- <label class="label-form" v-else>{{ titreDetailsUfa ? titreDetailsUfa.numufa :'' }}</label> -->
                                </b-form-group>
                                <b-form-group class="p-0 m-0"
                                    label-cols="3"
                        ...
                        <b-col cols="6">
                            <b-table v-model="currentItemUfa"  ref="selectableTableufa" select-mode="single" responsive="sm" hover  selectable 
                                ...
                                <template #cell(assiette)="data">
                                    <span>{{ formatAmount(data.item.assiette) }}</span>
                                </template>
                                <template #cell(superficie)="data">
...
export default{
    ...
    data(){
        return{
            ...
            fields:[
                {key:'numufa',label:'UFE'},
                {key:'assiette',label:'Assiette'},
