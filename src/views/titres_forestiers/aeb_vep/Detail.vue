<template>
    <div class="for_commun_cp">
        <tab-head :fermer="fermer" title="AEB"></tab-head>
                ...
                <b-col cols="6">
                    ...
                    >
                        <select disabled style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 1px) !important;">
                            <option value="ccp">Titre n°</option>
                        </select>
                    </b-form-group>
                    <b-form-group class="p-0 m-0"
                        label-cols="4"
        ...
        <div>
            <b-row>
                <b-col>
                    <b-tabs>
                        <b-tab title="Autorisation enlèvement du bois / Vente aux enchères n° 0904720">
                                ...
                                <b-row>
                                    ...
                                    <b-col cols="4">
                                        ...
                                        <b-form-group class="p-0 m-0"
                                            ...
                                            label-cols="8"
                                        >
                                            <label class="label-form">211</label>
                                        </b-form-group>
                                        <b-form-group class="p-0 m-0"
                                            label="Procès verbal n°"
                                            label-cols="8"
                                        >
                                            <label class="label-form">01MO</label>
                                        </b-form-group>
                                        <b-form-group class="p-0 m-0"
