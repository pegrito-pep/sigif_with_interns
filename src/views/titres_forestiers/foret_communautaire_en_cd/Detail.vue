<template>
    <div class="for_commun_cp">
        <tab-head :fermer="fermer" title="Forêt communautaire en convention définitive"></tab-head>
        ...
        <div>
            <b-row>
                <b-col>
                    <b-tabs>
                        <b-tab title="Forêt communautaire en  convention définitive n° 0904720">
                            <div class="ml-1 pl-3" style="border:1px solid grey">
                                <b-row>
                                    <b-col cols="4">
                                        <b-form-group class="p-0 m-0"
                                            label="Numéro de la convention de gestion"
                                            label-cols="8"
                                        >
                                            <label class="label-form">098</label>
                                        </b-form-group>
                                        <b-form-group class="p-0 m-0"
                                            label="N° lettre approbation PSG"
                                            label-cols="7"
                                        >
                                            <label class="label-form">81</label>
                                        </b-form-group>
                                        <b-form-group class="p-0 m-0"
                                            label="Durée"
                                            label-cols="7"
                                        ...
                                        >
                                            <div class="mt-2" style="display:flex;width:100%;justify-content: space-between;">
                                                <span style="font-style: italic;">convention.pdf</span><b-form-file id="actual-btn" plain class="form-control-sm"  size="sm" hidden/>
                                    ...
                                    <b-col cols="4">
                                        ...
                                        <b-form-group class="p-0 m-0"
                                            label="Lettre d'approbation"
                                            label-cols="5"
                                        >
                                            <div class="mt-2" style="display:flex;width:100%;justify-content: space-between;">
                                                <span style="font-style: italic;">approbation.pdf</span><b-form-file id="actual-btn" plain class="form-control-sm"  size="sm" hidden/>
                                                <label style="font-style: italic;color:green" for="actual-btn">Télécharger...</label>
                                            </div>
                                        </b-form-group>
                                        <b-form-group class="p-0 m-0"
                                            label="Plan simple de gestion"
                                            label-cols="5"
                                        >
                                        <div class="mt-2" style="display:flex;width:100%;justify-content: space-between;">
                                                <span style="font-style: italic;">plan gestion.pdf</span><b-form-file id="actual-btn" plain class="form-control-sm"  size="sm" hidden/>
                                                <label style="font-style: italic;color:green" for="actual-btn">Télécharger...</label>
                                            </div>
                                        </b-form-group>
                                    </b-col>
                                                    ...
                                                    <div style="border:1px solid grey">
                                                        ...
                                                        <div class="p-3">
                                                            <div class="pb-5">
                                                                <b-row>
                                                                <b-col>
                                                                    <h6 style="border-top:2px solid green">Liste des secteurs</h6>
                                                                    <b-table selectable hover :items="itemssecteurs" :fields="fieldssecteurs"
                                                            ...
                                                            <b-row>
                                                                <b-col cols="7">
                                                                    <h6 style="border-top:2px solid green">Liste des parcelles</h6>
                        ...
                        <b-tab title="Localisation Forêt communautaire n° 0904720">
...
<script>
    ...
    export default{
        ...
        methods:{
            fermer(){
                this.$router.push({name: 'foret_communautaire_en_cd' })
            },
            rowClass(item, type) {
                if(item !=''&&item!=null){
