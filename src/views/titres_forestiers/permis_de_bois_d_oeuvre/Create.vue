        ...
        <div>
          <b-row>
            <b-col><h4 class="tab-header-left-text">
              ...
              </button>Permis de bois d'oeuvre</h4></b-col>
          ...
          <div>
              <b-row class="m-4">
                  ...
                  <b-row class="m-2">
                    ...
                    <b-col cols="8">
                      <select disabled v-model="form.typetitre" class="m-0 p-0"  style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 2px) !important;">
                        <option value="PBO" selected disabled> Permis de bois d'oeuvre</option>
                      </select>
                    </b-col>
                  </b-row>
                ...
                <b-col cols="4">
                  <b-row class="m-2">
                    <b-col cols="6"> Catalogue du PEBO N°</b-col>
                    <b-col cols="4">
                  ...
                  <b-row class="m-2">
                    ...
                    <b-col cols="4">
                      <b-form-input v-model="form.superficie" name="quota" size="sm" class="p-0 m-0 font-weight-300 form-control-xs" placeholder=""  v-validate="{ required: true, min: 4 }" :state="validateState('quota')"/>
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item" :class="{ custumSigifTab: section === 'pbo' }">
                    <a
                    ref="intialtabselect"
                    data-toggle="tab"
                    href="#"
                    class="nav-link"
                    style="color: inherit"
                    @click.prevent="section = 'pbo'"
                    >Permis de bois d'oeuvre n° </a>
                </li>
              </ul>

              <b-container class="contents" fluid v-if="section == 'pbo'">
