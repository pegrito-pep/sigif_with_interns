            ...
            <b-card>
              <b-row class="p-1 mb-1" style="border-bottom:3px solid green">
                <b-col cols="6">
                    ...
                    <b-form-group class="p-0 m-0"
                        label="Concéssion forrestière en CD n° "
                        label-cols="4"
                        label-align="right"
                    >
                ...
                <b-col cols="4">
                    <b-form-group
                        ...
                        label-align="right"
                    >
                        <label class="mt-2 label-form"  v-if="titreDetails!==null">{{ titreDetails.superficie }}</label>
                    </b-form-group>
                </b-col>
              </b-row>
            </b-card>
              ...
              <b-row class="wrap" ref="wrap">
                  <b-tabs id="tabs" class="w-100" >
                    ...
                    <b-tab class="contents" @click.prevent="section = 'initialtab'">
                      <template #title>
                        <span v-if="titreDetails!==null">Concession en convention définitve coupe n° {{ titreDetails.numtitre }}</span>
                      </template>
                        <b-row class="mt-1">
                          <b-col sm="3">
                            <label for="input-small">convention définitve n° 
                              <span class="font-weight-bold" v-if="titreDetails!=null&&titreDetails.numconvention!=null">{{ titreDetails.numconvention }}</span> 
                            </label>
                          </b-col>
                          <b-col sm="3">
                            <label for="input-small">Date convention:</label>
                            <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.dateconvention!=null">{{ $dayjs(titreDetails.dateconvention).format("DD/MM/YYYY") }}</label>
                          ...
                          <b-col sm="3">
                            ...
                            <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.numcautionemment!=null">{{ titreDetails.numcautionemment }}</label>
                            <label  for="input-small" v-else>non défini</label>
                          </b-col>

                          <b-col sm="3">
                            <label for="input-small">Montant de l'offre pour calcul RFA:</label>
                          ...
                          <b-col sm="3">
                            ...
                            <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.datecautionnement!=null">{{ $dayjs(titreDetails.datecautionnement).format("DD/MM/YYYY") }}</label>
                            <label  for="input-small" v-else>non défini</label>
                          </b-col>
                          <b-col sm="3">
                            <label for="input-small">Durée:</label>
                            <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.duree!=null">{{ titreDetails.duree }}</label>
                            <label  for="input-small" v-else>non défini</label>
                          </b-col>
                          <b-col sm="3">
                          ...
                          <b-col sm="3">
                            <label for="input-small">Date de la notification:</label>
                            <label class="style" for="input-small"  v-if="titreDetails!=null&&titreDetails.datenotif!=null">{{ $dayjs(titreDetails.datenotif).format("DD/MM/YYYY") }}</label>
                            <label  for="input-small" v-else>non défini</label>
                          </b-col>
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Caution:
                              <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.caution!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.caution"><b-img src="@/assets/images/Attach_128x128.png"></b-img> caution</a>
                            </label>
                          </b-col>
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Attestation de conformité:</label>
                            <div class="">
                              <span v-if="titreDetails!=null&&titreDetails.attestationconf!=null"><a v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.attestationconf"><b-img src="@/assets/images/Attach_128x128.png"></b-img></a></span>
                            </div>
                          </b-col>
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Cahier des charges de la CD:</label>
                            <div class="">
                              <span v-if="titreDetails!=null&&titreDetails.cahierdeCharge!=null"><a v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.cahierdeCharge"><b-img src="@/assets/images/Attach_128x128.png"></b-img></a></span>
                            </div>
                          </b-col>
                          
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Plan d'aménagement:
                              <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.planamenagement!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.planamenagement"><b-img src="@/assets/images/Attach_128x128.png"></b-img> plan d'aménagement</a>
                            </label>
                         
                          </b-col>
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Arrêté d'approbation du plan d'aménagement :</label>
                            <div class="">
                              <span v-if="titreDetails!=null&&titreDetails.arretaproplanamenage!=null"><a v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.arretaproplanamenage"><b-img src="@/assets/images/Attach_128x128.png"></b-img></a></span>
                            </div>
                          </b-col>
                          <b-col sm="3" class="d-block">
                            <label for="input-small" class="">Décret d'attribution :
                              <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.decretattribution!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.decretattribution"><b-img src="@/assets/images/Attach_128x128.png"></b-img> décret d'attribution</a>
                            </label>
                          </b-col>
                          <b-col cols="12" sm="12">
                            <label for="input-small">Montant total de la RFA:</label>
                            <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.montantoffrerfatotal!=null">{{ formatAmount(titreDetails.montantoffrerfatotal) }}</label>
                          </b-col>
                        </b-row>
                          <b-row>
                            <b-col cols="4">
                              <b-button
                                ...
                                <ul>
                                  <li style="text-align: left" class="font-weight-bold" :class="{ 'collapse-open': visible, 'collapse-close': !visible }">Rapport des études socio économiques</li></ul>
                              </b-button>
                              <b-collapse id="collapse-4" v-model="visible">
                                <b-col>
                                    <label for="input-small">Numéro:</label>
                                    <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.detailinfo.rapetudesocioecon!=null">{{ titreDetails.detailinfo.rapetudesocioecon.numero }}</label>
                                  </b-col>
                                  <b-col>
                                    <label for="input-small">Date de signature:</label>
                                    <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.rapetudesocioecon!=null">{{ $dayjs(titreDetails.detailinfo.rapetudesocioecon.date_signature).format("DD/MM/YYYY") }}</label>
                                  </b-col>
                                  <b-col>
                                    <label for="input-small" class="">Document:</label>
                                      <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.detailinfo.rapetudesocioecon!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.detailinfo.rapetudesocioecon.document"><b-img src="@/assets/images/Attach_128x128.png"></b-img>document</a>
                                  </b-col>
                              </b-collapse>
                            </b-col>
                            <b-col cols="4">
                              <b-button
                                ...
                                @click="visible=!visible" class="p-0 m-0 pt-3" style="border:none; background: none; color:black">
                                <ul>
                                  <li style="text-align: left" class="font-weight-bold" :class="{ 'collapse-open': visible, 'collapse-close': !visible }">Procès verbal de la réunion de restitution de l'étude socio-économiques</li></ul>
                              </b-button>
                              <b-collapse id="collapse-4" v-model="visible">
                                <b-col>
                                    <label for="input-small">Numéro:</label>
                                    <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.detailinfo.procesverbetudesocioeco!=null">{{ titreDetails.detailinfo.procesverbetudesocioeco.numero }}</label>
                                  </b-col>
                                  <b-col>
                                    <label for="input-small">Date de signature:</label>
                                    <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.detailinfo.procesverbetudesocioeco!=null">{{ $dayjs(titreDetails.detailinfo.procesverbetudesocioeco.date_signature).format("DD/MM/YYYY") }}</label>
                                  </b-col>
                                  <b-col>
                                    <label for="input-small" class="">Document:
                                      <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.detailinfo.procesverbetudesocioeco!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.detailinfo.procesverbetudesocioeco.document"><b-img src="@/assets/images/Attach_128x128.png"></b-img> Document</a>
                                    </label>
                            ...
                            <b-col cols="4">
                              <b-button
                                ...
                                @click="visible=!visible" class="p-0 m-0 pt-3" style="border:none; background: none; color:black">
                                <ul>
                                  <li style="text-align: left" class="font-weight-bold" :class="{ 'collapse-open': visible, 'collapse-close': !visible }">Cartes d'affectation des terres</li></ul>
                              </b-button>
                              <b-collapse id="collapse-4" v-model="visible">
                                <b-col>
                                  <label for="input-small">Numéro:</label>
                                  <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.detailinfo.carteeffectationterre!=null">{{ titreDetails.detailinfo.carteeffectationterre.numero }}</label>
                                </b-col>
                                <b-col>
                                  <label for="input-small">Date de signature:</label>
                                  <label class="style" for="input-small" v-if="titreDetails!=null&&titreDetails.detailinfo.carteeffectationterre!=null">{{ $dayjs(titreDetails.detailinfo.carteeffectationterre.date_signature).format("DD/MM/YYYY") }}</label>
                                </b-col>
                                <b-col >
                                  <label for="input-small" class="">Document:
                                    <a class="mx-1 detail-permis-item" v-if="titreDetails!=null&&titreDetails.detailinfo.carteeffectationterre!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="titreDetails.detailinfo.carteeffectationterre.document"><b-img src="@/assets/images/Attach_128x128.png"></b-img> Document</a>
                                  </label>
                                </b-col>
                              </b-collapse>
                            </b-col>
                          ...
                          <b-card class="w-100" style="background-color: transparent;">
                              <b-row class="mt-1">
                                ...
                                <b-col cols="12" style="overflow-x:auto;position: relative; width: 1200px;">
                                  <!--entete des tableaux -->
                                  <div class="m-0 px-2 table-header-border-bottom" >
                                    <b-row>
                                      <b-col cols="">
                                        <h6 style="font-size: 16px !important;" class="tab-header-left-text mr-2"> Liste des UFE</h6>
                                      </b-col>
                                    </b-row>
                                  </div>
                                  <!--implémentation tableau proprement dite-->
                                  <div class="ml-1" style="position: relative; width: 1400px;">
                                      <b-table :busy="isBusy" hover select-mode="single" responsive="sm" ref="selectableTableufes" selectable @row-selected="onRowSelected"
                                      :items="itemsufe" 
                                      :fields="fieldsufe" 
                                      :tbody-tr-class="rowClass" >
                                        <template #table-busy>
                                        ...
                                        <template #cell(numufe)="data">
                                          <input disabled size="xs" class="w-50 mx-1 px-1 sigif-input-view text-right" :value="data.item.numufe" />
                                        </template>
                                        <template #cell(anneoverture)="data">
                                          <input disabled size="xs" class="w-50 mx-1 px-1 sigif-input-view text-right" :value="data.item.anneoverture" />
                                        </template>
                                        <template #cell(dernnierannee)="data">
                                          <input disabled size="xs" class="w-50 mx-1 px-1 sigif-input-view text-right" :value="data.item.dernnierannee" />
                                        </template>
                                        <template #cell(limites)="data">
                                          <a class="detail-permis-item" v-if="data.item!=null&&data.item.limites!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="data.item.limites"><b-img src="@/assets/images/Attach_128x128.png"></b-img> Limites</a>
                                        </template>
                                        <template #cell(approbPlangestion)="data">
                                          <a class="detail-permis-item" v-if="data.item!=null&&data.item.approbPlangestion!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="data.item.approbPlangestion"><b-img src="@/assets/images/Attach_128x128.png"></b-img>Approbation plan de gestion quinquenal</a>
                                        </template>
                                        <template #cell(parlleblocamenage)="data">
                                          <a class="detail-permis-item" v-if="data.item!=null&&data.item.parlleblocamenage!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="data.item.parlleblocamenage"><b-img src="@/assets/images/Attach_128x128.png"></b-img> Parcelle du bloc d'aménagement</a>
                                        </template>
                                        <template #cell(plangestionquiquenal)="data">
                                          <a class="detail-permis-item" v-if="data.item!=null&&data.item.plangestionquiquenal!=null" v-b-tooltip.hover title="consulter le fichier" target="_blank" :href="data.item.plangestionquiquenal"><b-img src="@/assets/images/Attach_128x128.png"></b-img> Plan de gestion quinquenal</a>
                                        </template>
                                        <template #cell(superficie)="data">
                                          <input disabled size="xs" class="w-75 mx-1 px-1 sigif-input-view text-right" :value="data.item.superficie" />
                                        </template>                                                        
                                      </b-table>
                                  </div>
                                </b-col>
                    ...
                    <b-tab class="contents" title="Localisation Concession en convention définitve n° 1002">
...
export default {
  ...
  data: () => ({
    ...
    fieldsufe: [ 
      { key: 'numufe', label: 'UFE n°', thStyle: { width: "10%"}},
      { key: 'anneoverture', label: "Année ouverture", thStyle: { width:"10%" }},
      { key: 'dernnierannee', label: "Dernière année", thStyle: { width:"10%" } },
      { key: 'limites', label: "Limites" },
      { key: 'approbPlangestion', label: "Approbation plan de gestion quinquenal" },
      { key: 'parlleblocamenage', label: "Parcellaire du bloc d'aménagement" },
      { key: 'plangestionquiquenal', label: "Plan de gestion quinquenal" },
      { key: 'superficie', label: "Superficie", thStyle: { width:"10%" } },
    ],
  ...
  computed:{
    ...
    itemsufe() { 
      return this.elementsufe.map((a, index) => {  
        a.isFirst = index == 0        
        a.isEven = index %2 == 0        
        return a
      })
  ...
  watch: {
    ...
    itemsufe(value){
        if(value.length>0){
            setTimeout(() => {this.$refs['selectableTableufes'].selectRow(0) }, 200);
        }
    },
 ...
 methods: {
    ...
    async getInitialData() {
      ...
      this.showOverlay = true
        this.titreDetails = await this.$titres.get('titre_convenssion/detail_cd/' +this.$route.params.id).then(response => response.data.result)
        this.elementsufa = this.titreDetails.ufaDtos
       // this.elementslocalisation = this.titreDetails.ufaDtos.repartsuparrond
        this.elementsufe = this.titreDetails.ufeDtos
