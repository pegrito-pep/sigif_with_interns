                        ...
                        <b-col cols="6">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a class="mx-1 detail-permis-item" v-else v-b-tooltip.hover  target="_blank" :href="path+limitesUfa"><b-img src="@/assets/images/Attach_128x128.png"></b-img> {{limitesUfa}}{{ limitesUfa ? (!(limitesUfa.toString().includes('.')) ? '.pdf':'') :''}}</a>
                                </b-form-group>
                            </div>
