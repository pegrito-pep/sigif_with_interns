  ...
  <div class="for_commun_cp">
              ...
              <b-col cols="6">
                  ...
                  >
                      <select disabled style="width: 100%;font-size:1rem; border-radius:0.25rem; height: calc(1em + .500rem + 1px) !important;">
                          <option value="ccp">Autorisation de récupération de bois</option>
                      </select>
                  </b-form-group>
                  <b-form-group class="p-0 m-0"
                      label-cols="4"
                  ...
                  >
                  <template #label>
                    <span style="color:red">*</span><span>Catalogue ARB n°</span>
                  </template>
      ...
      <div>
          <b-row>
              <b-col>
                  <b-tabs>
                      <b-tab title="Autorisation de récupération de bois n° 0904720">
