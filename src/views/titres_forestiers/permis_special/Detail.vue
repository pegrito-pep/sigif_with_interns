<template>
    <div class="for_commun_cp">
        <tab-head :fermer="fermer" title="Permis spécial"></tab-head>
        <b-row class="p-1 mb-1" style="border-bottom:3px solid green">
                <b-col cols="6">
                    ...
                    <b-form-group class="p-0 m-0"
                        label-cols="4"
                        label-align="right"
                        label="Catalogue du permis spécial n°"
                    >
        ...
        <div>
            <b-row>
                <b-col>
                    <b-tabs>
                        <b-tab title="Permis spécial n° 0904720">
  ...
  <script>
    ...
    export default{
        ...
        methods:{
            fermer(){
                this.$router.push({name: 'permis_special'})
            },
            rowClass(item, type) {
                if(item !=''&&item!=null){
