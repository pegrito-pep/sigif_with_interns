          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col>
                ...
                <!-- <a  size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/Parcs_Rupture_16x16.png"></b-img> UFA</a>
                <a :disabled="canCreateTitrePS" @click.prevent="addUser" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/Parcs_Usine_16x16.png"></b-img> UFE</a>
                <a :disabled="canCreateTitrePS" @click.prevent="addUser" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/iconABATTAGE_16x16.png"></b-img> AAC</a>
                <a :disabled="canCreateTitrePS" @click.prevent="addUser" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img  src="@/assets/images/Picto_tracabilite/iconINVENTAIRE_16x16.png"></b-img> Contrat de partenariat</a> -->
              </b-col>
              <b-col class="col-md-auto">
                <span class="d-flex">
                  
                  <a :disabled="!canCreateTitrePS" @click.prevent="goToCreateTitrePS" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img src="@/assets/images/iconPLUS_16x16.png"></b-img>Creer</a>
                  <a :disabled="!canCreateTitrePS" @click.prevent="showDetails" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img :class="{'change-image-opacity': !canUpdateConcessionDefinitive}" src="@/assets/images/iconMODIFIER_16x16.png"></b-img>Modifier</a>
                  <a :disabled="!canCreateTitrePS" @click.prevent="showDetails" size="sm" :class="{'change-image-opacity': !canCreateTitrePS,  'not-change-image-opacity': canCreateTitrePS}" class="mx-1 simple-btn"><b-img :class="{'change-image-opacity': !canDeleteConcessionDefinitive}" src="@/assets/images/iconSUPPRIMER_16x16.png"></b-img>Supprimer</a>
                  <a :disabled="!canViewTitrePS" style="cursor:pointer" @click.prevent="showDetails" size="sm" :class="{'change-image-opacity': !canViewTitrePS,  'not-change-image-opacity': canViewTitrePS}" class="mx-1 simple-btn"><b-img :class="{'change-image-opacity': !canViewTitrePS}" src="@/assets/images/iconVISUALISER_16x16.png"></b-img>consulter</a>
...
export default {
  ...
  computed:{
    ...
    canCreateTitrePS(){return true},
    canUpdateConcessionDefinitive(){return true},
    canDeleteConcessionDefinitive(){return false},
 ...
 methods: {
  goToCreateTitrePS(){this.$router.push({ name: "create-titre-ps" });},
  showDetails(){
    this.$router.push({ name: 'permis_special-detail' }); 
  },
  rowClass(item, type) {
    if(item !=''&&item!=null){
  ...
  getTitres(){
     this.isBusy=true
      ...
      this.$titres.get("titres/ps", {params}).then(response => {
    ...
    filterTable() {
      ...
      this.isBusy=true
      this.$titres.post("titres/ps/search", this.search).then((response) => {
          this.total = response.data.result.totalItems
          this.currentPage = response.data.result.currentPage + 1
          this.elements=response.data.result.items
