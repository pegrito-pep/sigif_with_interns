          ...
          <div>
            ...
            <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  <b-col cols="5">
                    <label for="" class="mr-2" style="white-space: nowrap;">Date signature</label>
                    <div class="d-flex">
                      <input placeholder="Du" type="text" class="form-control mr-1" />
                      <input placeholder="Au" type="text" class="form-control" />
                    </div>
                  </b-col>
                  <b-col cols="5">
                    <label for="" class="mr-2" style="white-space: nowrap;">Date effect</label>
                    <div class="d-flex">
                      <input placeholder="Du" type="text" class="form-control mr-1" />
                      <input placeholder="Au" type="text" class="form-control" />
                    </div>
                  ...
                  <b-col cols="4">
                    <label for="" class="mr-2" style="white-space: nowrap;">Ref. Arrêté</label>
                    <input placeholder="Reférence" type="text" class="form-control" />
                  </b-col>        
                </b-row>
      ...
      this.$donneesReference.get("valeurs-fob", {params}).then(response => {
        ...
        this.elements=response.data.result.items
         ...
         this.elements = this.elements.map(elt =>{
          elt.arreteno = elt.arreteFob.refArrete
          elt.datesig =  elt.arreteFob.dateSignature !==null ? this.$dayjs( elt.arreteFob.dateSignature).format('DD MMMM YYYY') :"" 
          elt.dateeff =  elt.arreteFob.dateEffet !==null ? this.$dayjs( elt.arreteFob.dateEffet).format('DD MMMM YYYY') :"" 
