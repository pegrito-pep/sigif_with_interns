<template>
    <div id="cover" class="min-vh-100">
              ...
              <b-card class="b-card">
                <b-row>
                  <b-col class="b-col" cols="2">
                    <SimpleInput libelle="Numpermis" />
                  </b-col>
                  <b-col class="b-col" cols="2">
                    <SimpleInput libelle="Numtitre" />
                  </b-col>
                  
                  <b-col cols="2" class="b-col">
                      <SelectInput libelle="serviceMinfof" :options="allEntitesForrestieres" />                    
                  </b-col>
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"><b-img src="@/assets/images/picto_user_vert.png"></b-img> Liste des inpections d'abattage</h4></b-col>
...
export default {
  ...
  data: () => ({
    ...
    //données du tableaux
    fields: [
        { key: 'nopermis', label: 'No du permis' },
        { key: 'dateinspection', label: 'Date d\'inspection' },
        { key: 'typetitre', label: 'Type de titre' },
        { key: 'titre', label: 'Titre' },
        { key: 'nomission', label: 'No ordre de mission' },
        { key: 'datesignature', label: 'Date de signature d\'ordre' },
        { key: 'debutmission', label: 'Date de début de mission' },
        { key: 'finmission', label: 'Date de fin de mission' },      

    ],
    elements: [
      {
        nopermis:'2003/PAO/MINFOF/S..',
        dateinspection: '13/04/2022',
        typetitre: 'concession forestiere',
        titre: 2003,
        nomission:10,
        datesignature:'12/04/2022',
        debutmission:'13/04/2022',
        finmission:'20/04/2022',
      },
    ],
 ...
 methods: {
  ...
  detailInspectionAbbattage(){
    this.$router.push({name:"details_inspection_abattage"})
  }
 },
