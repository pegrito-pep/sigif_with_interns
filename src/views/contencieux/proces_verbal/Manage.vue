  ...
  <div id="cover" class="min-vh-100">
      ...
      <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  ...
                  <b-col class="mt-2" cols="2" >
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('Agent verbalisateur')"   v-model="search.description"/>
                   
                  </b-col>
                  <b-col class="mt-2" cols="2">
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('No pv')"   v-model="search.unite"/>
    ...
    <div class="m-0 px-2 table-header-border">
      ...
      <b-row class="d-flex justify-content-between w-60">
        ...
        <div class="ml-5">
           <a   class="mx-1 simple-btn text-aligns-center"> Procès verbal</a>
        </div>
