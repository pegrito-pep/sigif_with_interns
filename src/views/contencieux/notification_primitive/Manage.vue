<template>
  <div id="cover" class="min-vh-100">
    <div>
            ...
            Liste des notifications primitives
          </h4>
            </div>
              ...
              <b-card class="b-card">
                ...
                <b-row>
                    ...
                    <sigif-form-group-vertical :px="1" :py=".9" class="mt-4" label="Montant de l'amende" v-model="search.amende" />
                    ...
                    <b-form-group class="m-0-0 p-0">
                          <div><label :px="1" :py=".9" for="" class=" p-0" style="display: inline-block">Statut du dossier</label></div> 
