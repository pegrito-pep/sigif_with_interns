...
<template>
  <div id="cover" class="min-vh-100">
    <div>
            ...
            Liste des décisions du tribunal</h4>
            </div>
      <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  <b-col class="mt-2" cols="2">
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('No pv')"   v-model="search.description"/>
                    
                   
                  </b-col>
                  <b-col class="mt-2" cols="2" >
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('Numero')"   v-model="search.description"/>
                  ...
                  <b-col cols="2">
                    ...
                    <b-form-group class="m-0-0 p-0">
                          <div><label for="" class=" p-0" style="display: inline-block mt-1">Statut du dossier</label></div> 
    ...
    <div class="m-0 px-2 table-header-border">
      <b-row>
        <b-col>
          <h4 class="tab-header-left-text">
            Liste des décisions du tribunal
          </h4>
          </b-col
        >
      ...
      <b-row class="d-flex justify-content-between w-60">
        ...
        <div class="ml-5">
           <a   class="mx-1 simple-btn text-aligns-center"> décision du tribunal</a>
        </div>
          
          
        
        <div class=" d-flex justify-content-end mr-5">
          <a  class="mx-1 simple-btn" >Actes de recouvrement</a >
