          ...
          <div>
            ...
            <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  <b-col cols="2">
                    <sigif-form-group-vertical :px="1" :py=".9" class="m-0" :label="$t('No notification')" v-model="search.identifiant"/>
                    <sigif-form-group-vertical :px="1" :py=".9" class="mt-4" label="No levée suspension" v-model="search.notitre" />
                  ...
                  <b-col cols="2">
                          ...
                          <b-col>
                        <label for="" class="m-0 p-0">Date de notification</label>
                      ...
                      <b-col style="margin-top: 17px !important;" class="m-0 mt-4 p-0">
                  ...
                  <b-col cols="2">
                      ...
                      <b-col>
                        <label for="" class="m-0 p-0">Date levée suspension</label>
                        <date-picker  v-model="search.datedeb" format="dddd, DD MMMM YYYY" placeholder="date de début" valueType="YYYY-MM-DD" class="w-100" :clearable="false" />
                      </b-col>
                      <b-col style="margin-top: 17px !important;" class="m-0 mt-4 p-0">
                        <label for="" class="m-0 p-0">Au</label>
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col>
                ...
                <h4 class="tab-header-left-text mt-0"> Liste des contencieux</h4></b-col>
