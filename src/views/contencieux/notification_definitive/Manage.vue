...
<template>
  <div id="cover" class="min-vh-100">
    <div>
            ...
            Liste des notifications définitives</h4>
            </div>
      <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  <b-col class="mt-2" cols="2">
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('Numero contencieux')"   v-model="search.description"/>
                    
                   
                  </b-col>
                  <b-col class="mt-2" cols="2" >
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('Amende NOP')"   v-model="search.description"/>
                   
                  </b-col>
                  <b-col class="mt-2" cols="2">
                    <sigif-form-group-vertical :px="1" :py=".9" :label="$t('No titre recouvrement')"   v-model="search.unite"/>
                  ...
                  <b-col cols="2">
                    ...
                    <b-form-group class="m-0-0 p-0">
                          <div>
                            <label for="" class=" p-0" style="display: inline-block m-0">Statut du dossier</label>
                            </div> 
                  ...
                  <b-col class="ml-1 position-relative">
                    ...
                    <div class="w-50 ml-5 mt-4" style="bottom: 0; right:1">
    ...
    <div class="m-0 px-2 table-header-border">
      <b-row>
        <b-col>
          <h4 class="tab-header-left-text">
            Liste des notifications définitives
          </h4>
          </b-col
        >
      ...
      <b-row class="d-flex justify-content-between w-60">
        ...
        <div class="ml-5">
           <a   class="mx-1 simple-btn text-aligns-center"> notification définitive</a>
        </div>
...
export default {
  ...
  data: () => ({
    ...
    fields: [
      { key: "index", label: "" },
      { key: "idligne", label: "No contencieux" },
      { key: "intitule", label: "Numero du pv" },
      { key: "entite", label: "Agent verbalisateur" },
      { key: "uniteproduction", label: "Date du pv" },
      { key: "description", label: "Statut du pv" },
      { key: "motifrejet", label: "Arrondissement" },
