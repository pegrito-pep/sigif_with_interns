<template>
    <div id="cover" class="min-vh-100">
              ...
              <b-card class="b-card">
                <b-row>
                  <b-col class="b-col" cols="3">
                    <SimpleInput libelle="NoDDE" />
                    <SimpleInput libelle="NoTitre" />
                  </b-col>
                  
                  <b-col cols="3" class="b-col">
                    <SimpleInput libelle="Exercice" />
                    <SelectInput libelle="Statut" :options="allEntitesForrestieres" />
                  </b-col>
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"><b-img src="@/assets/images/picto_user_vert.png"></b-img>Liste des demandes de certificat</h4></b-col>
...
export default {
  ...
  data: () => ({
    ...
    //données du tableaux
    fields: [
        { key: 'nodde', label: 'NoDDE' },
        { key: 'notitre', label: 'No Titre' },
        { key: 'exercice', label: 'Exercice' },
        { key: 'numero', label: 'Numéro certificat' },
        { key: 'date', label: 'Date signature' }, 
        { key: 'objet', label: 'Objet du certificat' },
    ...
    elements: [
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Oui", organisation: "", statut: "Validé", codebarre: "256FEC5", motivation: "RAS",},
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Oui", organisation: "", statut: "Soumis", codebarre: "256FEC5", motivation: "RAS",},
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Non", organisation: "", statut: "Validé", codebarre: "256FEC5", motivation: "RAS",},
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Oui", organisation: "", statut: "Validé", codebarre: "256FEC5", motivation: "RAS",},
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Non", organisation: "", statut: "Validé", codebarre: "256FEC5", motivation: "RAS",},
      {nodde: "25962", notitre: "848FR", exercice: "2021", numero: "5295925", date: "12/06/2021", objet: "Certificat de légalité", prive: "Non", organisation: "", statut: "Soumis", codebarre: "256FEC5", motivation: "RAS",},
    ],
