<template>
    <div id="cover" class="min-vh-100">
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"><b-img src="@/assets/images/picto_user_vert.png"></b-img>Liste des certificats</h4></b-col>
    ...
    elements: [
      {
        ...
        notitre:'',
        exercice: 2021,
        numero: '002/CL/MINFOF/SET...',
        date: '16/05/2021',
        objet:'UTB',
        prive:'Non',
        organisation:'BOIS LEGAL CAMEROUN',
        statut:'Activé',
      ...
      },
      {
        ...
        notitre: 2001,
        exercice: 2021,
        numero: '006/CL/MINFOF/SET...',
        date: '17/05/2021',
        objet:'Concession forestiere en convention provisoire',
        prive:'Non',
        organisation:'BOIS LEGAL CAMEROUN',
        statut:'Activé',
      ...
      },
      {
        ...
        notitre: 2000,
        exercice: 2021,
        numero: '2000/CL/MINFOF/SET...',
        date: '14/05/2021',
        objet:'Concession forestiere en convention définitive',
        prive:'Non',
        organisation:'BOIS LEGAL CAMEROUN',
        statut:'Activé',
      ...
      },
      {
        ...
        notitre: 52021,
        exercice: 2021,
        numero: '02101/CL/MINFOF',
        date: '17/05/2021',
        objet:'Vente de coupe',
        prive:'Non',
        organisation:'BOIS LEGAL CAMEROUN',
        statut:'Activé',
