        ...
        <template #overlay>
          ...
          <b-row class="ml-2" style="border-bottom: 2px solid green">
            <b-col class="pb-1 m-1" >
              ...
              <span class="form_title">Modification Lettre de voiture N° <span>{{ lettreV.idoperation }}</span> </span>
              </h4>
              </b-col> 
            ...
            <b-col class="col-md-auto">
              <span class="d-flex justify-content-between">
                ...
                <a v-else @click.prevent="modifier" :disabled="submitted"  size="sm"   class="mx-1 px-1 simple-btn" style="cursor: pointer"><b-img src="@/assets/images/picto_enregistrer_vert.png"></b-img>Modifier</a>
          ...
          <!--ENTETE EDITION Lv -->
            ...
            <div>
              <b-row>
                ...
                <b-col cols="6">
                  <b-row class="mx-2">
                    <b-col cols="4">
                          <span  class="m-0 py-2" style="color: #333333;">code à barre</span>
                    </b-col>
                    <b-col cols="8">
                      <div class="mt-1">
                        <span>{{ lettreV.codebarre }}</span>
                      </div>
                    </b-col>
                  </b-row>
                  <b-row class="mx-2">
                    ...
                    <b-col cols="8">
                      <div class="mt-1">
                        <b-form-checkbox  v-model="lettreV.estlvVierge" name="checkbox-1" value="1"
                        unchecked-value="0"  id="statut"></b-form-checkbox>
                      </div>
                    </b-col>
                  </b-row>
                  <b-row class="my-1">
                  ...
                  <b-row class="my-1">
                    ...
                    <b-col cols="8">
                        <select disabled v-model="lettreV.typeopeparc" :class="{ 'styleToSet': notSetTypelv }" class="default-old-system-select-properties w-75">
                          <option value=""></option>
                  ...
                  <b-row class="my-1" v-if="lettreV.estlvVierge==0||lettreV.estlvVierge==null">
                    <b-col  cols="4">
                  ...
                  <b-row class="my-1">
                    <b-col  cols="4">
                      <span  style="color: #333333; display: flex; justify-content: end;">Numéro d'identifiant unique (NIU)</span>
                    </b-col>
                    <b-col  cols="8">
                      <input type="text" v-model="lettreV.niu" class="form-control-xs my-1 w-50" disabled>
                    </b-col>
                  </b-row>
                  <b-row v-if="lettreV.estlvVierge=='null'||lettreV.estlvVierge=='0'" class="my-1">
                    <b-col cols="4">
                ...
                <b-col cols="6">
                  ...
                  <!--<b-row v-if="lettreV.modetransport=='ECL'&&lettreV.typetransport=='VF'" class="my-1">
                    <b-col cols="4">
                  ...
                  <b-row class="my-1" v-if="lettreV.caslv=='MO'&&lettreV.estlvVierge==0||lettreV.estlvVierge==null">
                    <b-col cols="4">
                      <span  style="color: #333333; display: flex; justify-content: end;"> Nom du transporteur</span>
                    </b-col>
                    <b-col cols="8">
                  ...
                  <b-row class="my-1" >
                    <span v-if="lettreV.modetransport=='ECL'&&lettreV.typetransport=='R'" class="d-flex w-100">
                      <b-col cols="4">
                    ...
                    <span v-if="(lettreV.estlvVierge==0||lettreV.estlvVierge==null)&&(lettreV.modetransport!='ECL'&&lettreV.typetransport!='R')" class="d-flex w-100">
                      <b-col cols="4">
                  ...
                  <b-row v-if="lettreV.caslv!=''" class="my-1">
                    ...
                    <b-col cols="8">
                      <v-select @input="loadSitesDestination" v-model="lettreV.sitedepart" :options="paginatedSitesdepart" :reduce="site => site.IDSITEOPER" :filterable="false" @search="onSearchSitedepart" label="INTITULE" class="custom-select-type_titre  w-50"   :class="{'styleToSet': notSetSitedepart }">
                          <li slot="list-footer" class="pagination">
            ...
            <!--GESTION TABLEAU DES CODES BARRES-->
            <div v-if="lettreV.contentProduit==true" style="height: 600px; overflow-y: auto; overflow-x: hidden;">
              <div class="m-4 px-2 table-header-border mt-5">
                <b-row>
                    ...
                    <b-col class="liens">
                      <a style="cursor: pointer" @click.prevent="addFieldDebites" class="mx-1 simple-btn"><b-img  src="@/assets/images/iconPLUS_16x16.png"></b-img>Ajouter</a>
                      <a style="cursor: pointer" @click.prevent="RemouveAllFieldsDebites"  class="mx-1 simple-btn"><b-img class="mr-1" src="@/assets/images/iconSUPPRIMER_16x16.png"></b-img>Tout supprimer</a>
              ...
              <b-overlay class="m-4 px-2" rounded="sm" :show="showOverlayCodeData">
                <div>
                  <b-table v-model="currentItemColis" :items="itemsdebites"  :fields="fieldsdebites" class="mt-1" outlined   ref="selectableDebites" select-mode="single" selectable @row-selected="onRowSelectedDebites" :tbody-tr-class="rowClass">
                    ...
                    <template #cell(nombrePieces)="data">
                      <input disabled size="xs" class="d-flex justify-content-center align-items-center w-75 mx-1 px-1 sigif-input-view text-left"  style="color:white!important" v-model="data.item.nombrePieces" />
                    </template>
                    ...
                    <template #cell(action)="data">
                      <b-button size="sm" class="d-flex justify-content-center"  title="enlever" @click.prevent="RemouveFieldDebites(data.index)" variant="outline-danger"><i class="ik ik-trash-2"></i></b-button>
                    </template>
                  ...
                  <b-table sticky-header="250px" :busy="isBusyDetailsDebites" hover select-mode="single" responsive="sm" :items="itemsDetailsDebites"  :fields="fieldsDetailsDebites" :tbody-tr-class="rowClass" ref="selectableTableDetailsDebites" selectable @row-selected="onRowSelected" show-empty>
                    ...
                    <template v-slot:head(nmbpiece)="data"><span v-html="data.field.label" style="color:green; font-size:0.8rem"></span></template>
                    ...
                    <template v-slot:head(volume)="data"><span v-html="data.field.label" style="color:green; font-size:0.8rem"></span></template>
                      ...
                      <template #table-busy>
                        ...
                        <template #cell(nmbpiece)="data">
                         <b-form-input disabled size="sm" class="w-75 py-0 px-2 m-0 change_bg" style="height: 20px !important; color:black; border: 1px solid white; text-align:right" placeholder="" v-model="data.item.nmbpiece" />
                        </template>
...
export default {
  ...
  components:{
   ...
   data: () => ({
      ...
      fieldsdebites: [ 
        ...
        { key: 'nombrePieces', label: 'Nombre de pièces',thStyle:"width:14%" },
  ...
  methods: {
    async modifier() {
      let data={
        typelv:this.lettreV.typeopeparc, caslv:this.lettreV.caslv, datechargement:this.lettreV.datechargement,
        modetransport:this.lettreV.modetransport, typetransport:this.lettreV.typetransport, nomtransporteur:this.lettreV.nomtransporteur,
        niutransporteur: this.lettreV.niutransporteur, 
        niuachetteur:this.lettreV.niuachetteur!=undefined?this.lettreV.niuachetteur:'', 
        chauffeur:this.lettreV.chauffeur,
        immatriculation:this.lettreV.immatriculation, sitedepart: this.lettreV.sitedepart, sitedestination:this.lettreV.sitedestination,
        numplomb:this.lettreV.numplomb!=undefined?this.lettreV.numplomb:'', 
        taillecontainer:this.lettreV.taillecontainer!=undefined?this.lettreV.taillecontainer:'', 
        numempotage:this.lettreV.numempotage!=undefined?this.lettreV.numempotage:'',
        numcontainer:this.lettreV.numcontainer!=undefined?this.lettreV.numcontainer:'', 
        commentaire:this.lettreV.commentaire!=undefined?this.lettreV.commentaire:''
      }
      ...
      if (php.empty(this.lettreV.caslv)) {
        ...
        if(this.lettreV.estlvVierge!='1'){
          ...
          if(this.lettreV.typeopeparc=='LVD'){
            console.log('les codes barres débités');
            this.elementsdebites.forEach(elt =>{
              codebarres.push(elt.codebarre)
            })
            data.grumes=codebarres
          }
        }
          this.submitted = true 
          this.$operationParc.put('lettres-voiture/modifier/'+this.lettreV.idoperation, data).then(response => {
    ...
    onRowSelectedDebites(items){
      ...
      if(!php.empty(items)&&!php.empty(items[0].detailsdebites)){
        this.elementsdetailsdebites =items[0].detailsdebites
      }
    },
    showImportSection(){
    ...
    addFieldDebites(){
        ...
        if(this.lettreV.typeopeparc=='LVD'){
          this.elementsdebites.unshift({codebarre: '', sequence: '', essence:'', longueur:'',epaisseur:'',nbpieces:'',volume:'', });
        }
      },
      ...
      RemouveFieldDebites(index){
        this.elementsdebites.splice(index, 1);
      },
      RemouveAllFieldsDebites(){
      ...
      async checkCodebarreLv(value,index, commande){
          this.showOverlayCodeData=true;
            if(commande='codebarre'){
              if(this.lettreV.typeopeparc=='LVD'){
                await this.$codesbarres.post("check/check_codebarre_lettre_voiture", {codebarre : value, typelv:this.lettreV.typeopeparc, sitedepart: this.lettreV.sitedepart })
                .then(response =>{
                  console.log('response ',response);
                  this.dataresult =response.data.result
                  this.elementsdebites[this.indexRowSelectedColis].sequence =this.dataresult.sequence
                  this.elementsdebites[this.indexRowSelectedColis].essence =this.dataresult.essence
                  this.elementsdebites[this.indexRowSelectedColis].longueur =this.dataresult.longueur
                  this.elementsdebites[this.indexRowSelectedColis].epaisseur =this.dataresult.epaisseur
                  this.elementsdebites[this.indexRowSelectedColis].nombrePieces =this.dataresult.nombrePieces
                  this.elementsdebites[this.indexRowSelectedColis].volume =this.dataresult.volume
                  this.elementsdebites[this.indexRowSelectedColis].detailsdebites =this.dataresult.detailsdebites

                  this.elementsdebites[this.indexRowSelectedColis].detailsdebites = !php.empty(this.dataresult.detailsdebites)?this.dataresult.detailsdebites:[]
                  this.elementsdetailsdebites = !php.empty(this.dataresult.detailsdebites)?response.data.result.detailsdebites:[]
    ...
    async getDetailsLettre() {
      const params = this.getRequestParams(
        ...
        if(this.lettreV.datechargement!=null&&this.lettreV.datechargement!=''){
          this.lettreV.datechargement=this.lettreV.datechargement.split('T')[0]
        }
        ...
        if(this.lettreV.typeopeparc=='LVD'){
          ...
          this.elementsdebites=this.lettreV.listeElements.details
        } 
      ...
      if(!php.empty(this.sites)){
        ...
        console.log('jusquici ',this.lettreV);
        //gestion du cas spécifique MO
        if(this.lettreV.caslv=='MO'){
          this.sites.forEach(site => {
          if(site.IDORGANISATION ==this.user.idOrganisation&&site.TYPESITEOPER !=="UTB"&&site.IDSITEOPER!=this.lettreV.sitedepart){
            console.log('entrée ici 2 s');
            this.sitesDestination.push(site)
          }
        }) 
        }else{
