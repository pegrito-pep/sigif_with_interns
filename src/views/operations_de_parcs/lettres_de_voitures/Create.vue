              ...
              <b-row>
                ...
                <b-col cols="6">
                  ...
                  <b-row class="my-1" >
                    ...
                    <span v-else-if="lettrev.typetransport=='VF'" class="d-flex w-100">
                      <b-col cols="4">
...
export default {
  ...
  methods: {
    ...
    AddFichierAssocie () {
      this.fields.push( {codebarre: '', sequence: '', nomcommercial: "", numgrume: "", dpb: '', dgb: '', longueur: '', volume: '',});
    },

    
    deleteAll(){
      this.fields = [ {codebarre: '', sequence: '', nomcommercial: "", numgrume: "", dpb: '', dgb: '', longueur: '', volume: '',}]
    },
