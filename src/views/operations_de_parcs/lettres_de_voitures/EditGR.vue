          ...
          <!--ENTETE EDITION Lv -->
            ...
            <div v-if="lettreV.contentProduit==true" style="height: 600px; overflow-y: auto; overflow-x: hidden;">
              ...
              <b-overlay class="m-4 px-2" rounded="sm" :show="showOverlayCodeData">
                <b-table height="50px" :items="itemsgrumes"  :fields="fieldsgrumes" class="mt-1" outlined   ref="selectableTablegrumes" select-mode="single" selectable @row-selected="onRowSelected" :tbody-tr-class="rowClass">
...
export default {
  ...
  components:{
   ...
   data: () => ({
      ...
      fieldsgrumes: [ 
        { key: 'index', label: '' },
        { key: 'codebarre', label: 'Code à barre' }, { key: 'sequence', label: 'Séquence' },
        { key: 'numdf10', label: 'N° grume' }, 
  ...
  methods: {
    ...
    async getDetailsLettre() {
      const params = this.getRequestParams(
        ...
        this.elementsgrumes=this.lettreV.listeElements.details
        console.log('elements grumes ',this.elementsgrumes);
        //debut traitement des sites
  ...
  beforeMount() {
    console.log('rr ',new Date().toISOString().substr(0, 10),);
