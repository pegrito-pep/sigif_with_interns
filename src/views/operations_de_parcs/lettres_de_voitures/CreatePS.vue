          ...
          <!--ENTETE CREATION Lv -->
              ...
              <b-row>
                ...
                <b-col cols="6">
                  ...
                  <b-row class="my-1">
                    ...
                    <b-col cols="8">
                        <select v-model="lettrev.typelv" :class="{ 'styleToSet': notSetTypelv }" class="default-old-system-select-properties w-75">
                          <option value=""></option>
                  ...
                  <b-row class="my-1" v-if="lettrev.caslv==2">
                    <b-col cols="4">
            ...
            <div v-if="lettrev.lvvierge=='false'" style="height: 600px; overflow-y: auto; overflow-x: hidden;">
              ...
              <b-overlay class="m-4 px-2" rounded="sm" :show="showOverlayCodeData">
                ...
                <div v-if="lettrev.typelv=='LVD'">
                  <b-table height="50px" :items="itemsdebites"  :fields="fieldsdebites" class="mt-1" outlined   ref="selectableTabledebites" select-mode="single" selectable @row-selected="onRowSelectedDebites" :tbody-tr-class="rowClass">
                    <template v-slot:head(codebarre)="data">
                      <span v-html="data.field.label" style="color:green"></span>
                    </template>
                    <template v-slot:head(sequence)="data">
                    ...
                    <template #cell(nbpieces)="data">
                      <input disabled size="xs" class="d-flex justify-content-center align-items-center w-75 mx-1 px-1 sigif-input-view text-left"  style="color:white!important" v-model="data.item.nbpieces" />
                    </template>
                    <template #cell(volume)="data">
                      <input disabled size="xs" class="d-flex justify-content-center align-items-center w-75 mx-1 px-1 sigif-input-view text-left"  style="color:white!important" v-model="data.item.volume" />
                    </template>
                  ...
                  <b-table height="50px" :items="itemsdetailsdebites"  :fields="fieldsdetailsdebites" class="mt-1" outlined   ref="selectableCodesDebites" select-mode="single" selectable @row-selected="onRowSelected" :tbody-tr-class="rowClass">
                    ...
                    <template #cell(nmbpiece)="data">
                      <input disabled size="xs" class="d-flex justify-content-center align-items-center w-50 mx-1 px-1 sigif-input-view text-left"  style="color:white!important" v-model="data.item.nmbpiece" />
                    </template>
  ...
  components:{
   ...
   data: () => ({
      ...
      fieldsgrumes: [ 
        ...
        { key: 'numgrume', label: 'N° grume' }, { key: 'nomcommercial', label: 'Nom commercial',thStyle:"width:20%" },
  ...
  methods: {
    ...
    addFieldGrume (){
        ...
        if(this.lettrev.typelv=='LVG'){
          this.elementsgrumes.unshift({codebarre: '', reference: '', lignedf10: "", nomcommercial:'', diampb:'',diamgb:'',longueur:'',volume:'', });
        }
        if(this.lettrev.typelv=='LVD'){
          this.elementsdebites.unshift({codebarre: '', sequence: '', nomcommercial:'', longueur:'',epaisseur:'',nbpieces:'',volume:'', });
        }
      },
            ...
            if(commande='codebarre'){
              if(this.lettrev.typelv=='LVG'){
                ...
                .then(response =>{
                  ...
                  this.elementsgrumes[index].numgrume=this.dataresult.numgrume !==null ? this.dataresult.numgrume :"" ;
              ...
              if(this.lettrev.typelv=='CL'){
                await this.$codesbarres.post("check/check_codebarre_lettre_voiture", {codebarre : value, typelv:this.lettrev.typelv, sitedepart: this.lettrev.sitedepart })
                .then(response =>{
                  this.dataresult =response.data.result
                  this.elementsdebites[index].sequence=this.dataresult.Items[0].reference;
                  this.elementsdebites[index].nomcommercial=this.dataresult.Items[0].nomcommercial;

                  
                  this.elementsdetailsdebites = response.data.result.detailsdebites
                  this.showOverlayCodeData=false;
                })
                .catch(error =>{
    ...
    onRowSelected(items) {
      ...
      this.isRowselected=true
          ...
          console.log('d ',php.empty(this.selected.sequence));
    },
    ...
    AddFichierAssocie () {
      this.fields.push( {codebarre: '', sequence: '', nomcommercial: "", numgrume: "", diampb: '', diamgb: '', longueur: '', volume: '',});
    },

    
    deleteAll(){
      this.fields = [ {codebarre: '', sequence: '', nomcommercial: "", numgrume: "", diampb: '', diamgb: '', longueur: '', volume: '',}]
    },
    ...
    async enregistrer() {
      ...
      if (php.empty(this.lettrev.caslv)) {
        ...
        if(this.lettrev.lvvierge=='false'){
          ...
          let codebarres= []
          if(this.lettrev.typelv=='LVG'){
            console.log('lettres grume 1',this.elementsgrumes);
          ...
          console.log('données envoyées ',this.lettrev);
              this.submitted = true 
