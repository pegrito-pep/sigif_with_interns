        ...
        <b-row>
          <b-col>
            <h4 class="tab-header-left-text">
              ...
              >Consultation Demande de permis n°:{{ demandedetail.idpermis }}</span>
            </h4>
          </b-col>
          ...
          <b-col cols="4">
           ...
           <b-col cols="4">
             <div>Type de titre: <label class="style" for="input-small">{{ demandedetail.typetitre }}</label></div>
              <div>Vente de coupe No:<label class="style" for="input-small">0052021</label></div>
           </b-col>
            <b-col cols="4"><div>Type de permis:<label class="style" for="input-small">Certificat vente de coupe</label></div>
                <div>Traitement sylvicole:<label  class="style" for="input-small">COUPE TOTALE</label>
                </div>
            </b-col>
        </b-row>
      </b-card>
