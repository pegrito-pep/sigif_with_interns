                    ...
                    <b-col cols="5" class="m-0 p-0">
                      ...
                      >
                        ...
                        <div class="d-flex align-items-center h-100" style="flex-wrap:wrap">
                          ...
                          <span v-if="!form.numpermis" style="color:red">{{ errors.message }}</span>
                  ...
                  <b-col cols="3" class="m-0 p-0">
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center h-100" style="flex-wrap:wrap">
                        ...
                        <span style="color:red" v-if="!form.dateabattage">{{ errors.message }}</span>
                      </div>
                ...
                <div class="m-0 px-2 table-header-border">
                  <b-row>
                    ...
                    <b-col class="ml-1 liens">
                      <a style="cursor: pointer;" @click.prevent="AddField" class="mx-2 simple-btn"><b-img src="@/assets/images/iconPLUS_16x16.png"></b-img><span style="color:rgba(0,100,0,0.7)">Ajouter</span></a>
  ...
  computed:{
    ...
    methods: {
      ...
      async getDataDetailsTige(value) {
        ...
        let data={idtitre:this.form.numtitre, idaacpermis:this.form.idaac, codebarre:value}
          
         await this.$codesbarres.post("verifincentaire", data).then(response => {
      ...
      async getDataDetailsGrume(value) {
        ...
        this.showOverlayGrume=true;
          ...
          let dataresult =  await this.$codesbarres.post("check/codebarre-sequence", {codebarre : value}).then(response => response.data.result)
            .catch(error =>{
      ...
      resetTigesFields(){
        this.form.codebarretige='', this.form.codebarregrume='', this.form.sequencegrume='', this.form.essence='', this.form.diampb='', this.form.diampg='', this.form.longeur='', this.form.abandonner='', this.form.motifabandon=''
      },
