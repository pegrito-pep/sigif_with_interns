              ...
              <b-card class="b-card">
                <b-row>
                  <b-col class="b-col" cols="2">
                    <SimpleInput libelle="Nom arrondissement / commune" />
                    <SimpleInput libelle="Zone" />
                  </b-col>
                  ...
                  <b-col cols="3" class="b-col">
                    ...
                    <b-row class="content">
                      ...
                      <SelectInput libelle="Département" :options="allEntitesForrestieres" />
                    </b-row>
