<template>
    <div id="cover" class="min-vh-100">
            ...
            <b-collapse id="collapse-4" v-model="visible">
              <b-card class="b-card">
                <b-row>
                  ...
                  <b-col cols="3">
                    <b-form-group   label-cols="4" label-cols-lg="3" label-size="sm" label="Banques" label-for="input-sm">
                        <v-select label="libelle"  :options="allEntitesForrestieres" class="custum-vselect-border" ></v-select>
                    </b-form-group>
                  </b-col>
                  <b-col cols="3">
                    <sigif-form-group  :px="1" :py=".9" :label-cols="4" :label-cols-lg="4" label="Code banque" :reduceSize="width"/>
                  </b-col>
                  <b-col class="d-flex flex-row justify-content-end">
                    <div style="margin-top: -2px" class="p-0" >
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"><b-img src="@/assets/images/picto_user_vert.png"></b-img> Liste des banques</h4></b-col>
...
getBanques(){
     this.isBusy=true
      ...
      this.$donneesReference.get("banques", {params}).then(response => {
          console.log("=================== Données de reference / banques ==================");
