<template>
    <div id="cover" class="min-vh-100">
              ...
              <b-card class="b-card">
                <b-row>
                  <b-col class="b-col" cols="2">
                    <sigif-form-group  :px="1" :py=".9"  :label-cols="4" :label-cols-lg="4" label="Code" v-model="search.code"/>
                    <sigif-form-group  :px="1" :py=".9"  :label-cols="4" :label-cols-lg="4" label="Nom" v-model="search.nom"/>
                  </b-col>
                  <b-col cols="3" class="b-col">
                    <b-row class="content">
                      <div class="d-flex mb-3" style="width: 80px">
                      ...
                      <SelectInput libelle="Continent" :options="allEntitesForrestieres" />
                    </b-row>
          ...
          <div class="m-0 px-2 table-header-border">
            <b-row>
              <b-col><h4 class="tab-header-left-text"><b-img src="@/assets/images/picto_user_vert.png"></b-img>Rapport</h4></b-col>
